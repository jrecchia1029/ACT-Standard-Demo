...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.2.16/24 | 10.0.2.1 |
...
| --------- | --------------- | ------------ | --------- |
| CH3-Leaf2 | Vlan4094 | 192.168.14.104 | Port-Channel491 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49/1 | MLAG_CH3-Leaf2A_Ethernet49/1 | *trunk | *- | *- | *MLAG | 491 |
| Ethernet50/1 | MLAG_CH3-Leaf2A_Ethernet50/1 | *trunk | *- | *- | *MLAG | 491 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet51/1 | P2P_CH3-Spine1_Ethernet6/1 | - | 192.168.12.21/31 | default | 1500 | False | - | - |
| Ethernet52/1 | P2P_CH3-Spine2_Ethernet6/1 | - | 192.168.12.23/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description MLAG_CH3-Leaf2A_Ethernet49/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description MLAG_CH3-Leaf2A_Ethernet50/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet51/1
   description P2P_CH3-Spine1_Ethernet6/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet52/1
   description P2P_CH3-Spine2_Ethernet6/1
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel491 | MLAG_CH3-Leaf2A_Port-Channel491 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel491
   description MLAG_CH3-Leaf2A_Port-Channel491
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.245.218.8/32 |
...
| 192.168.12.20 | 65050 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.12.22 | 65050 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65053
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65053
   neighbor MLAG-IPv4-UNDERLAY-PEER next-hop-self
   neighbor MLAG-IPv4-UNDERLAY-PEER description CH3-Leaf2A
   ...
   neighbor 192.168.12.20 remote-as 65050
   neighbor 192.168.12.20 description CH3-Spine1_Ethernet6/1
   neighbor 192.168.12.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.12.22 remote-as 65050
   neighbor 192.168.12.22 description CH3-Spine2_Ethernet6/1
   neighbor 192.168.14.72 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 192.168.14.72 description CH3-Leaf2A_Vlan4093
