...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.1.16/24 | 10.0.1.1 |
...
| --------- | --------------- | ------------ | --------- |
| NY5-Leaf2 | Vlan4094 | 192.168.13.104 | Port-Channel491 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49/1 | MLAG_NY5-Leaf2A_Ethernet49/1 | *trunk | *- | *- | *MLAG | 491 |
| Ethernet50/1 | MLAG_NY5-Leaf2A_Ethernet50/1 | *trunk | *- | *- | *MLAG | 491 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet51/1 | P2P_NY5-Spine1_Ethernet6/1 | - | 192.168.11.21/31 | default | 1500 | False | - | - |
| Ethernet52/1 | P2P_NY5-Spine2_Ethernet6/1 | - | 192.168.11.23/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description MLAG_NY5-Leaf2A_Ethernet49/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description MLAG_NY5-Leaf2A_Ethernet50/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet51/1
   description P2P_NY5-Spine1_Ethernet6/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet52/1
   description P2P_NY5-Spine2_Ethernet6/1
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel491 | MLAG_NY5-Leaf2A_Port-Channel491 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel491
   description MLAG_NY5-Leaf2A_Port-Channel491
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.245.217.8/32 |
...
router bgp 65003
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description NY5-Leaf2A
   ...
   neighbor 192.168.11.20 description NY5-Spine1_Ethernet6/1
   neighbor 192.168.11.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.11.22 remote-as 65000
   neighbor 192.168.11.22 description NY5-Spine2_Ethernet6/1
   neighbor 192.168.13.72 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 192.168.13.72 description NY5-Leaf2A_Vlan4093
