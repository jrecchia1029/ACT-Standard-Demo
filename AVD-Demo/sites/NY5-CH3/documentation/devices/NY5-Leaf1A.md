...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.1.13/24 | 10.0.1.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet51/1 | P2P_NY5-Spine1_Ethernet3/1 | - | 192.168.11.9/31 | default | 1500 | False | - | - |
| Ethernet52/1 | P2P_NY5-Spine2_Ethernet3/1 | - | 192.168.11.11/31 | default | 1500 | False | - | - |
...
interface Ethernet51/1
   description P2P_NY5-Spine1_Ethernet3/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet52/1
   description P2P_NY5-Spine2_Ethernet3/1
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65001
   ...
   neighbor 192.168.11.8 description NY5-Spine1_Ethernet3/1
   neighbor 192.168.11.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.11.10 remote-as 65000
   neighbor 192.168.11.10 description NY5-Spine2_Ethernet3/1
