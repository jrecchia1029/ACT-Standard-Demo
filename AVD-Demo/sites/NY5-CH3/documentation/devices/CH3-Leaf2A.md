...
| 192.168.12.16 | 65050 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.12.18 | 65050 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65053
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description CH3-Leaf2B
   ...
   neighbor 192.168.12.16 remote-as 65050
   neighbor 192.168.12.16 description CH3-Spine1_Ethernet5/1
   neighbor 192.168.12.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.12.18 remote-as 65050
   neighbor 192.168.12.18 description CH3-Spine2_Ethernet5/1
   neighbor 192.168.14.73 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 192.168.14.73 description CH3-Leaf2B_Vlan4093
