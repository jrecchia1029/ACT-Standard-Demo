...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.1.12/24 | 10.0.1.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1 | P2P_NY5-Border-Leaf-A_Ethernet52/1 | - | 192.168.11.2/31 | default | 1500 | False | - | - |
| Ethernet2/1 | P2P_NY5-Border-Leaf-B_Ethernet52/1 | - | 192.168.11.6/31 | default | 1500 | False | - | - |
| Ethernet3/1 | P2P_NY5-Leaf1A_Ethernet52/1 | - | 192.168.11.10/31 | default | 1500 | False | - | - |
| Ethernet4/1 | P2P_NY5-Leaf1B_Ethernet52/1 | - | 192.168.11.14/31 | default | 1500 | False | - | - |
| Ethernet5/1 | P2P_NY5-Leaf2A_Ethernet52/1 | - | 192.168.11.18/31 | default | 1500 | False | - | - |
| Ethernet6/1 | P2P_NY5-Leaf2B_Ethernet52/1 | - | 192.168.11.22/31 | default | 1500 | False | - | - |
...
interface Ethernet1/1
   description P2P_NY5-Border-Leaf-A_Ethernet52/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet2/1
   description P2P_NY5-Border-Leaf-B_Ethernet52/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet3/1
   description P2P_NY5-Leaf1A_Ethernet52/1
   no shutdown
   mtu 1500
   no switchport
   ip address 192.168.11.10/31
!
interface Ethernet4/1
   description P2P_NY5-Leaf1B_Ethernet52/1
   no shutdown
   mtu 1500
   no switchport
   ip address 192.168.11.14/31
!
interface Ethernet5/1
   description P2P_NY5-Leaf2A_Ethernet52/1
   no shutdown
   mtu 1500
   no switchport
   ip address 192.168.11.18/31
!
interface Ethernet6/1
   description P2P_NY5-Leaf2B_Ethernet52/1
   no shutdown
   mtu 1500
   no switchport
   ip address 192.168.11.22/31
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.245.217.2/32 |
...
| 192.168.11.3 | 65005 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.11.7 | 65005 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.11.11 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.11.15 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.11.19 | 65003 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.11.23 | 65003 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65000
   ...
   neighbor 192.168.11.3 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.11.3 remote-as 65005
   neighbor 192.168.11.3 description NY5-Border-Leaf-A_Ethernet52/1
   neighbor 192.168.11.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.11.7 remote-as 65005
   neighbor 192.168.11.7 description NY5-Border-Leaf-B_Ethernet52/1
   neighbor 192.168.11.11 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.11.11 remote-as 65001
   neighbor 192.168.11.11 description NY5-Leaf1A_Ethernet52/1
   neighbor 192.168.11.15 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.11.15 remote-as 65002
   neighbor 192.168.11.15 description NY5-Leaf1B_Ethernet52/1
   neighbor 192.168.11.19 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.11.19 remote-as 65003
   neighbor 192.168.11.19 description NY5-Leaf2A_Ethernet52/1
   neighbor 192.168.11.23 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.11.23 remote-as 65003
   neighbor 192.168.11.23 description NY5-Leaf2B_Ethernet52/1
