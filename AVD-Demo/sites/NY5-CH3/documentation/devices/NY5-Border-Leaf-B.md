...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.1.18/24 | 10.0.1.1 |
...
| --------- | --------------- | ------------ | --------- |
| NY5-Border-Leaf | Vlan4094 | 192.168.13.96 | Port-Channel491 |
...
!
mlag configuration
   domain-id NY5-Border-Leaf
   local-interface Vlan4094
   peer-address 192.168.13.96
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49/1 | MLAG_NY5-Border-Leaf-A_Ethernet49/1 | *trunk | *- | *- | *MLAG | 491 |
| Ethernet50/1 | MLAG_NY5-Border-Leaf-A_Ethernet50/1 | *trunk | *- | *- | *MLAG | 491 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet51/1 | P2P_NY5-Spine1_Ethernet2/1 | - | 192.168.11.5/31 | default | 1500 | False | - | - |
| Ethernet52/1 | P2P_NY5-Spine2_Ethernet2/1 | - | 192.168.11.7/31 | default | 1500 | False | - | - |
| Ethernet54/1 | P2P_WAN-1_Ethernet2/1 | - | 10.255.0.3/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description MLAG_NY5-Border-Leaf-A_Ethernet49/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description MLAG_NY5-Border-Leaf-A_Ethernet50/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet51/1
   description P2P_NY5-Spine1_Ethernet2/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet52/1
   description P2P_NY5-Spine2_Ethernet2/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet54/1
   description P2P_WAN-1_Ethernet2/1
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel491 | MLAG_NY5-Border-Leaf-A_Port-Channel491 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel491
   description MLAG_NY5-Border-Leaf-A_Port-Channel491
   no shutdown
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan4093 |  default  |  192.168.13.65/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.168.13.97/31  |  -  |  -  |  -  |  -  |
...
!
interface Vxlan1
   description NY5-Border-Leaf-B_VTEP
...
| 10.255.0.2 | 64750 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 192.168.13.64 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65005
   ...
   neighbor INTER-DC-EVPN-PEERS remote-as 65055
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description NY5-Border-Leaf-A
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.245.217.1 peer group EVPN-OVERLAY-PEERS
   neighbor 10.245.217.1 remote-as 65000
   neighbor 10.245.217.1 description NY5-Spine1_Loopback0
   neighbor 10.245.217.2 peer group EVPN-OVERLAY-PEERS
   neighbor 10.245.217.2 remote-as 65000
   neighbor 10.245.217.2 description NY5-Spine2_Loopback0
   neighbor 10.245.218.7 peer group INTER-DC-EVPN-PEERS
   neighbor 10.245.218.7 description CH3-Border-Leaf-A
   neighbor 10.245.218.8 peer group INTER-DC-EVPN-PEERS
   neighbor 10.245.218.8 description CH3-Border-Leaf-B
   neighbor 10.255.0.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.0.2 remote-as 64750
   neighbor 10.255.0.2 description WAN-1
   neighbor 192.168.11.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.11.4 remote-as 65000
   neighbor 192.168.11.4 description NY5-Spine1_Ethernet2/1
   neighbor 192.168.11.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.11.6 remote-as 65000
   neighbor 192.168.11.6 description NY5-Spine2_Ethernet2/1
   neighbor 192.168.13.64 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 192.168.13.64 description NY5-Border-Leaf-A_Vlan4093
