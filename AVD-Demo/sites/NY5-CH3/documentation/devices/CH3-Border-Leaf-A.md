...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.2.17/24 | 10.0.2.1 |
...
| --------- | --------------- | ------------ | --------- |
| CH3-Border-Leaf | Vlan4094 | 192.168.14.97 | Port-Channel491 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49/1 | MLAG_CH3-Border-Leaf-B_Ethernet49/1 | *trunk | *- | *- | *MLAG | 491 |
| Ethernet50/1 | MLAG_CH3-Border-Leaf-B_Ethernet50/1 | *trunk | *- | *- | *MLAG | 491 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet51/1 | P2P_CH3-Spine1_Ethernet1/1 | - | 192.168.12.1/31 | default | 1500 | False | - | - |
| Ethernet52/1 | P2P_CH3-Spine2_Ethernet1/1 | - | 192.168.12.3/31 | default | 1500 | False | - | - |
| Ethernet54/1 | P2P_WAN-1_Ethernet3/1 | - | 10.255.0.5/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description MLAG_CH3-Border-Leaf-B_Ethernet49/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description MLAG_CH3-Border-Leaf-B_Ethernet50/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet51/1
   description P2P_CH3-Spine1_Ethernet1/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet52/1
   description P2P_CH3-Spine2_Ethernet1/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet54/1
   description P2P_WAN-1_Ethernet3/1
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel491 | MLAG_CH3-Border-Leaf-B_Port-Channel491 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel491
   description MLAG_CH3-Border-Leaf-B_Port-Channel491
   no shutdown
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan4093 |  default  |  192.168.14.64/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.168.14.96/31  |  -  |  -  |  -  |  -  |
...
!
interface Vxlan1
   description CH3-Border-Leaf-A_VTEP
...
| 10.255.0.4 | 64750 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.12.0 | 65050 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.12.2 | 65050 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.14.65 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65055
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description CH3-Border-Leaf-B
   ...
   neighbor 10.255.0.4 remote-as 64750
   neighbor 10.255.0.4 description WAN-1
   neighbor 192.168.12.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.12.0 remote-as 65050
   neighbor 192.168.12.0 description CH3-Spine1_Ethernet1/1
   neighbor 192.168.12.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.12.2 remote-as 65050
   neighbor 192.168.12.2 description CH3-Spine2_Ethernet1/1
   neighbor 192.168.14.65 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 192.168.14.65 description CH3-Border-Leaf-B_Vlan4093
