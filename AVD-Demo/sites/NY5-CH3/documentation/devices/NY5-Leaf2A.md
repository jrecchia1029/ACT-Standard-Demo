...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.1.15/24 | 10.0.1.1 |
...
| --------- | --------------- | ------------ | --------- |
| NY5-Leaf2 | Vlan4094 | 192.168.13.105 | Port-Channel491 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49/1 | MLAG_NY5-Leaf2B_Ethernet49/1 | *trunk | *- | *- | *MLAG | 491 |
| Ethernet50/1 | MLAG_NY5-Leaf2B_Ethernet50/1 | *trunk | *- | *- | *MLAG | 491 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet51/1 | P2P_NY5-Spine1_Ethernet5/1 | - | 192.168.11.17/31 | default | 1500 | False | - | - |
| Ethernet52/1 | P2P_NY5-Spine2_Ethernet5/1 | - | 192.168.11.19/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description MLAG_NY5-Leaf2B_Ethernet49/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description MLAG_NY5-Leaf2B_Ethernet50/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet51/1
   description P2P_NY5-Spine1_Ethernet5/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet52/1
   description P2P_NY5-Spine2_Ethernet5/1
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel491 | MLAG_NY5-Leaf2B_Port-Channel491 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel491
   description MLAG_NY5-Leaf2B_Port-Channel491
   no shutdown
...
router bgp 65003
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description NY5-Leaf2B
   ...
   neighbor 192.168.11.16 description NY5-Spine1_Ethernet5/1
   neighbor 192.168.11.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.11.18 remote-as 65000
   neighbor 192.168.11.18 description NY5-Spine2_Ethernet5/1
   neighbor 192.168.13.73 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 192.168.13.73 description NY5-Leaf2B_Vlan4093
