...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.2.24/24 | 10.0.2.1 |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.245.218.6/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.245.218.38/32 |
...
| 192.168.12.12 | 65050 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.12.14 | 65050 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65052
   ...
   neighbor 192.168.12.12 remote-as 65050
   neighbor 192.168.12.12 description CH3-Spine1_Ethernet4/1
   neighbor 192.168.12.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.12.14 remote-as 65050
   neighbor 192.168.12.14 description CH3-Spine2_Ethernet4/1
