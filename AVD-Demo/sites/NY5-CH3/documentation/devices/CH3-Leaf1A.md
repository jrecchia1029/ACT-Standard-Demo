...
| 192.168.12.8 | 65050 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.12.10 | 65050 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65051
   ...
   neighbor 192.168.12.8 remote-as 65050
   neighbor 192.168.12.8 description CH3-Spine1_Ethernet3/1
   neighbor 192.168.12.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.12.10 remote-as 65050
   neighbor 192.168.12.10 description CH3-Spine2_Ethernet3/1
