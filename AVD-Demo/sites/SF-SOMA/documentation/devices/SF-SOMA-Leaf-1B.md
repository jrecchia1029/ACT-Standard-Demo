...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.14.7/24 | 10.0.14.1 |
...
| Ethernet51 | L2_SF-SOMA-Spine-1_Ethernet2 | *trunk | *10,20,30,4092 | *- | *- | 51 |
| Ethernet52 | L2_SF-SOMA-Spine-2_Ethernet2 | *trunk | *10,20,30,4092 | *- | *- | 51 |
...
interface Ethernet50
   description MLAG_SF-SOMA-Leaf-1A_Ethernet50
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
interface Ethernet51
   description L2_SF-SOMA-Spine-1_Ethernet2
   no shutdown
   channel-group 51 mode active
!
interface Ethernet52
   description L2_SF-SOMA-Spine-2_Ethernet2
   no shutdown
   channel-group 51 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | MLAG_SF-SOMA-Leaf-1A_Port-Channel49 | trunk | - | - | MLAG | 30 | individual | - | - |
...
interface Port-Channel49
   description MLAG_SF-SOMA-Leaf-1A_Port-Channel49
   no shutdown
