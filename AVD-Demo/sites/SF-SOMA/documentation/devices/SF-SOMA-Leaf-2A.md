...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.14.8/24 | 10.73.252.1 |
...
interface Ethernet97/1
   description L2_SF-SOMA-Spine-1_Ethernet3
   no shutdown
   channel-group 971 mode active
!
interface Ethernet98/1
   description L2_SF-SOMA-Spine-2_Ethernet3
   no shutdown
   channel-group 971 mode active
```
