...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_SF-SOMA-Leaf-1A_Ethernet52 | *trunk | *10,20,30,4092 | *- | *- | 1 |
| Ethernet2 | L2_SF-SOMA-Leaf-1B_Ethernet52 | *trunk | *10,20,30,4092 | *- | *- | 1 |
| Ethernet3 | L2_SF-SOMA-Leaf-2A_Ethernet98/1 | *trunk | *10,20,30,4092 | *- | *- | 3 |
| Ethernet4 | L2_SF-SOMA-Leaf-3A_Ethernet52 | *trunk | *10,20,30,4092 | *- | *- | 4 |
| Ethernet5 | L2_SF-SOMA-Leaf-3B_Ethernet52 | *trunk | *10,20,30,4092 | *- | *- | 4 |
| Ethernet49/1 | MLAG_SF-SOMA-Spine-1_Ethernet49/1 | *trunk | *- | *- | *MLAG | 491 |
| Ethernet50/1 | MLAG_SF-SOMA-Spine-1_Ethernet50/1 | *trunk | *- | *- | *MLAG | 491 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet51/1 | P2P_WAN-1_Ethernet14/1 | - | 10.255.0.27/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description L2_SF-SOMA-Leaf-1A_Ethernet52
   no shutdown
...
!
interface Ethernet2
   description L2_SF-SOMA-Leaf-1B_Ethernet52
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
!
interface Ethernet3
   description L2_SF-SOMA-Leaf-2A_Ethernet98/1
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
!
interface Ethernet4
   description L2_SF-SOMA-Leaf-3A_Ethernet52
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
!
interface Ethernet5
   description L2_SF-SOMA-Leaf-3B_Ethernet52
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
interface Ethernet49/1
   description MLAG_SF-SOMA-Spine-1_Ethernet49/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description MLAG_SF-SOMA-Spine-1_Ethernet50/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet51/1
   description P2P_WAN-1_Ethernet14/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.255.0.27/31
```
...
| Port-Channel491 | MLAG_SF-SOMA-Spine-1_Port-Channel491 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel491
   description MLAG_SF-SOMA-Spine-1_Port-Channel491
   no shutdown
   switchport mode trunk
...
| Loopback10 | DIAG_VRF_CORPORATE | CORPORATE | 10.255.254.146/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.0.26 | 64750 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65300
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description SF-SOMA-Spine-1
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.255.0.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.0.26 remote-as 64750
   neighbor 10.255.0.26 description WAN-1
   neighbor 192.168.255.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 192.168.255.0 description SF-SOMA-Spine-1_Vlan4093
