...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.14.10/24 | 10.73.252.1 |
...
interface Ethernet49
   description MLAG_SF-SOMA-Leaf-3A_Ethernet49
   no shutdown
...
interface Ethernet50
   description MLAG_SF-SOMA-Leaf-3A_Ethernet50
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
interface Ethernet51
   description L2_SF-SOMA-Spine-1_Ethernet5
   no shutdown
   channel-group 51 mode active
!
interface Ethernet52
   description L2_SF-SOMA-Spine-2_Ethernet5
   no shutdown
   channel-group 51 mode active
!
interface Ethernet53
   description L2_SF-SOMA-Leaf-3C_Ethernet26
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
interface Ethernet54
   description L2_SF-SOMA-Leaf-3D_Ethernet26
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
interface Ethernet55
   description L2_SF-SOMA-Leaf-3E_Ethernet26
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
interface Port-Channel49
   description MLAG_SF-SOMA-Leaf-3A_Port-Channel49
   no shutdown
