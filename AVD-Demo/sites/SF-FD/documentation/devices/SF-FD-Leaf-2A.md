...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.15.8/24 | 10.0.15.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet97/1 | P2P_SF-FD-Spine-1_Ethernet3 | - | 10.250.15.9/31 | default | 1500 | False | - | - |
| Ethernet98/1 | P2P_SF-FD-Spine-2_Ethernet3 | - | 10.250.15.11/31 | default | 1500 | False | - | - |
...
interface Ethernet97/1
   description P2P_SF-FD-Spine-1_Ethernet3
   no shutdown
   mtu 1500
   no switchport
   ip address 10.250.15.9/31
!
interface Ethernet98/1
   description P2P_SF-FD-Spine-2_Ethernet3
   no shutdown
   mtu 1500
   no switchport
   ip address 10.250.15.11/31
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.255.255.165/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.255.254.165/32 |
| Loopback10 | DIAG_VRF_CORPORATE | CORPORATE | 10.255.255.165/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.255.255.165/32
!
interface Loopback1
   description VXLAN_TUNNEL_SOURCE
   no shutdown
   ip address 10.255.254.165/32
!
...
!
interface Vxlan1
   description SF-FD-Leaf-2A_VTEP
...
| --- | ------------------- | ------------ | ---------------- |
| CORPORATE | 10.255.255.165:10 | connected | - |
| default | 10.255.255.165:1 | - | - |
...
router bgp 65352
   ...
   neighbor 10.250.15.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.250.15.8 remote-as 65350
   neighbor 10.250.15.8 description SF-FD-Spine-1_Ethernet3
   ...
   !
   vlan 10
      rd 10.255.255.165:10010
      route-target both 10010:10010
      redistribute learned
   !
   vlan 20
      rd 10.255.255.165:10020
...
| -------------- | ----------------------- | ----------------------- |
| CORPORATE | 10.255.255.165 | - |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf CORPORATE address 10.255.255.165
```
