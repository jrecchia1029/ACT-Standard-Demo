...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.15.7/24 | 10.0.15.1 |
...
| --------- | --------------- | ------------ | --------- |
| MLAG | Vlan4094 | 169.254.0.0 | Port-Channel49 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet51 | P2P_SF-FD-Spine-1_Ethernet2 | - | 10.250.15.5/31 | default | 1500 | False | - | - |
| Ethernet52 | P2P_SF-FD-Spine-2_Ethernet2 | - | 10.250.15.7/31 | default | 1500 | False | - | - |
...
interface Ethernet50
   description MLAG_SF-FD-Leaf-1A_Ethernet50
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
interface Ethernet51
   description P2P_SF-FD-Spine-1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 10.250.15.5/31
!
interface Ethernet52
   description P2P_SF-FD-Spine-2_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 10.250.15.7/31
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | MLAG_SF-FD-Leaf-1A_Port-Channel49 | trunk | - | - | MLAG | 30 | individual | - | - |
...
interface Port-Channel49
   description MLAG_SF-FD-Leaf-1A_Port-Channel49
   no shutdown
...
!
interface Vxlan1
   description SF-FD-Leaf-1B_VTEP
...
| 40 | 10.255.255.164:10040 | 10040:10040 | - | - | learned |
...
router bgp 65351
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description SF-FD-Leaf-1A
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.250.15.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.250.15.4 remote-as 65350
   neighbor 10.250.15.4 description SF-FD-Spine-1_Ethernet2
