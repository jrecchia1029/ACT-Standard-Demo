...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.15.6/24 | 10.0.15.1 |
...
| --------- | --------------- | ------------ | --------- |
| MLAG | Vlan4094 | 169.254.0.1 | Port-Channel49 |
...
| Ethernet49 | MLAG_SF-FD-Leaf-1B_Ethernet49 | *trunk | *- | *- | *MLAG | 49 |
| Ethernet50 | MLAG_SF-FD-Leaf-1B_Ethernet50 | *trunk | *- | *- | *MLAG | 49 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet51 | P2P_SF-FD-Spine-1_Ethernet1 | - | 10.250.15.1/31 | default | 1500 | False | - | - |
| Ethernet52 | P2P_SF-FD-Spine-2_Ethernet1 | - | 10.250.15.3/31 | default | 1500 | False | - | - |
...
interface Ethernet49
   description MLAG_SF-FD-Leaf-1B_Ethernet49
   no shutdown
...
interface Ethernet50
   description MLAG_SF-FD-Leaf-1B_Ethernet50
   no shutdown
   switchport access vlan 4092
   switchport mode access
   switchport
...
interface Ethernet51
   description P2P_SF-FD-Spine-1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet52
   description P2P_SF-FD-Spine-2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.250.15.3/31
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | MLAG_SF-FD-Leaf-1B_Port-Channel49 | trunk | - | - | MLAG | 30 | individual | - | - |
...
interface Port-Channel49
   description MLAG_SF-FD-Leaf-1B_Port-Channel49
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.255.255.163/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.255.254.163/32 |
| Loopback10 | DIAG_VRF_CORPORATE | CORPORATE | 10.255.255.163/32 |
...
!
interface Vxlan1
   description SF-FD-Leaf-1A_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.250.15.0 | 65350 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.250.15.2 | 65350 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.255.255.163:10010 | 10010:10010 | - | - | learned |
| 20 | 10.255.255.163:10020 | 10020:10020 | - | - | learned |
| 30 | 10.255.255.163:10030 | 10030:10030 | - | - | learned |
| 40 | 10.255.255.163:10040 | 10040:10040 | - | - | learned |
| 4092 | 10.255.255.163:14092 | 14092:14092 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| CORPORATE | 10.255.255.163:10 | connected | - |
| default | 10.255.255.163:1 | - | - |
...
router bgp 65351
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65351
   neighbor MLAG-IPv4-UNDERLAY-PEER next-hop-self
   neighbor MLAG-IPv4-UNDERLAY-PEER description SF-FD-Leaf-1B
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.250.15.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.250.15.0 remote-as 65350
   neighbor 10.250.15.0 description SF-FD-Spine-1_Ethernet1
   neighbor 10.250.15.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.250.15.2 remote-as 65350
   neighbor 10.250.15.2 description SF-FD-Spine-2_Ethernet1
   ...
   neighbor 192.168.255.1 description SF-FD-Leaf-1B_Vlan4093
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 10
      rd 10.255.255.163:10010
      route-target both 10010:10010
      redistribute learned
   !
   vlan 20
      rd 10.255.255.163:10020
      route-target both 10020:10020
      redistribute learned
   !
   vlan 30
      rd 10.255.255.163:10030
      route-target both 10030:10030
      redistribute learned
   !
   vlan 40
      rd 10.255.255.163:10040
      route-target both 10040:10040
      redistribute learned
   !
   vlan 4092
      rd 10.255.255.163:14092
   ...
   !
   vrf CORPORATE
      rd 10.255.255.163:10
      route-target import evpn 10:10
      route-target export evpn 10:10
      router-id 10.255.255.163
      neighbor 192.168.255.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 192.168.255.1 description SF-FD-Leaf-1B_Vlan3009
...
| -------------- | ----------------------- | ----------------------- |
| CORPORATE | 10.255.255.163 | - |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf CORPORATE address 10.255.255.163
```
